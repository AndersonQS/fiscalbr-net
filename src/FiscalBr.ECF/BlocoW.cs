...
namespace FiscalBr.ECF
{
    public class BlocoW
    {
        ...
        public class RegW100 : RegistroSped
        {
            ...
            [SpedCampos(3, "IND_CONTROLADORA", "C", 1, 0, true, 2)]
            public string IndControladora { get; set; }

            [SpedCampos(4, "NOME_CONTROLADORA", "C", 0, 0, true, 2)]
            public string NomeControladora { get; set; }

            [SpedCampos(5, "JURISDICAO_CONTROLADORA", "C", 2, 0, true, 2)]
            public string JurisdicaoControladora { get; set; }

            [SpedCampos(6, "TIN_CONTROLADORA", "C", 0, 0, true, 2)]
            public string TinControladora { get; set; }

            [SpedCampos(7, "IND_ENTREGA", "N", 1, 0, true, 2)]
            public int IndEntrega { get; set; }

            [SpedCampos(8, "IND_MODALIDADE", "N", 1, 0, true, 2)]
            public int IndModalidade { get; set; }

            [SpedCampos(9, "NOME_SUBSTITUTA", "C", 0, 0, false, 2)]
            public string NomeSubstituta { get; set; }

            [SpedCampos(10, "JURISDICAO_SUBSTITUTA", "C", 2, 0, false, 2)]
            public string JurisdicaoSubstituta { get; set; }

            [SpedCampos(11, "TIN_SUBSTITUTA", "N", 14, 0, false, 2)]
            public string TinSubstituta { get; set; }

            [SpedCampos(12, "DT_INI", "N", 8, 0, false, 2)]
            public DateTime? DtIni { get; set; }

            [SpedCampos(13, "DT_FIN", "N", 8, 0, false, 2)]
            public DateTime? DtFin { get; set; }

            [SpedCampos(14, "TIP_MOEDA", "C", 3, 0, false, 2)]
            public string TipMoeda { get; set; }

            [SpedCampos(15, "IND_IDIOMA", "C", 2, 0, false, 2)]
        ...
        public class RegW200 : RegistroSped
        {
            ...
            [SpedCampos(3, "VL_REC_NAO_REL_EST", "NS", 19, 2, false, 2)]
            public decimal? VlRecNaoRelEst { get; set; }

            [SpedCampos(4, "VL_REC_NAO_REL", "NS", 19, 2, true, 2)]
            public decimal? VlRecNaoRel { get; set; }

            [SpedCampos(5, "VL_REC_REL_EST", "NS", 19, 2, false, 2)]
            public decimal? VlRecRelEst { get; set; }

            [SpedCampos(6, "VL_REC_REL", "NS", 19, 2, true, 2)]
            public decimal? VlRecRel { get; set; }

            [SpedCampos(7, "VL_REC_TOTAL_EST", "NS", 19, 2, false, 2)]
            public decimal? VlRecTotalEst { get; set; }

            [SpedCampos(8, "VL_REC_TOTAL", "NS", 19, 2, true, 2)]
            public decimal? VlRecTotal { get; set; }

            [SpedCampos(9, "VL_LUC_PREJ_ANTES_IR_EST", "NS", 19, 2, false, 2)]
            public decimal? VlLucPrejAntesIrEst { get; set; }

            [SpedCampos(10, "VL_LUC_PREJ_ANTES_IR", "NS", 19, 2, true, 2)]
            public decimal? VlLucPrejAntesIr { get; set; }

            [SpedCampos(11, "VL_IR_PAGO_EST", "NS", 19, 2, false, 2)]
            public decimal? VlIrPagoEst { get; set; }

            [SpedCampos(12, "VL_IR_PAGO", "NS", 19, 2, true, 2)]
            public decimal? VlIrPago { get; set; }

            [SpedCampos(13, "VL_IR_DEVIDO_EST", "NS", 19, 2, false, 2)]
            public decimal? VlIrDevidoEst { get; set; }

            [SpedCampos(14, "VL_IR_DEVIDO", "NS", 19, 2, true, 2)]
            public decimal? VlIrDevido { get; set; }

            [SpedCampos(15, "VL_CAP_SOC_EST", "NS", 19, 2, false, 2)]
            public decimal? VlCapSocEst { get; set; }

            [SpedCampos(16, "VL_CAP_SOC", "NS", 19, 2, true, 2)]
            public decimal? VlCapSoc { get; set; }

            [SpedCampos(17, "VL_LUC_ACUM_EST", "NS", 19, 2, false, 2)]
            public decimal? VlLucAcumEst { get; set; }

            [SpedCampos(18, "VL_LUC_ACUM", "NS", 19, 2, true, 2)]
            public decimal? VlLucAcum { get; set; }

            [SpedCampos(19, "VL_ATIV_TANG_EST", "NS", 19, 2, false, 2)]
            public decimal? VlAtivTangEst { get; set; }

            [SpedCampos(20, "VL_ATIV_TANG", "NS", 19, 2, true, 2)]
            public decimal? VlAtivTang { get; set; }

            [SpedCampos(21, "NUM_EMP", "N", 7, 2, true, 2)]
        ...
        public class RegW250 : RegistroSped
        {
            ...
            [SpedCampos(4, "TIN", "C", 0, 0, true, 2)]
            public string Tin { get; set; }

            [SpedCampos(5, "JURISDICAO_TIN", "C", 2, 0, false, 2)]
            public string JurisdicaoTin { get; set; }

            [SpedCampos(6, "NI", "C", 0, 0, false, 2)]
            public string Ni { get; set; }

            [SpedCampos(7, "JURISDICAO_NI", "C", 2, 0, false, 2)]
            public string JurisdicaoNi { get; set; }

            [SpedCampos(8, "TIPO_NI", "C", 0, 0, false, 2)]
            public string TipoNi { get; set; }

            [SpedCampos(9, "TIP_END", "C", 7, 0, true, 2)]
            public string TipEnd { get; set; }

            [SpedCampos(10, "ENDEREÇO", "C", 150, 0, true, 2)]
            public string Endereco { get; set; }

            [SpedCampos(11, "NUM_TEL", "C", 15, 0, false, 2)]
            public string NumTel { get; set; }

            [SpedCampos(12, "EMAIL", "C", 115, 0, false, 2)]
            public string Email { get; set; }

            [SpedCampos(13, "ATIV_1", "C", 1, 0, true, 2)]
            public string Ativ1 { get; set; }

            [SpedCampos(14, "ATIV_2", "C", 1, 0, true, 2)]
            public string Ativ2 { get; set; }

            [SpedCampos(15, "ATIV_3", "C", 1, 0, true, 2)]
            public string Ativ3 { get; set; }

            [SpedCampos(16, "ATIV_4", "C", 1, 0, true, 2)]
            public string Ativ4 { get; set; }

            [SpedCampos(17, "ATIV_5", "C", 1, 0, true, 2)]
            public string Ativ5 { get; set; }

            [SpedCampos(18, "ATIV_6", "C", 1, 0, true, 2)]
            public string Ativ6 { get; set; }

            [SpedCampos(19, "ATIV_7", "C", 1, 0, true, 2)]
            public string Ativ7 { get; set; }

            [SpedCampos(20, "ATIV_8", "C", 1, 0, true, 2)]
            public string Ativ8 { get; set; }

            [SpedCampos(21, "ATIV_9", "C", 1, 0, true, 2)]
            public string Ativ9 { get; set; }

            [SpedCampos(22, "ATIV_10", "C", 1, 0, true, 2)]
            public string Ativ10 { get; set; }

            [SpedCampos(23, "ATIV_11", "C", 1, 0, true, 2)]
            public string Ativ11 { get; set; }

            [SpedCampos(24, "ATIV_12", "C", 1, 0, true, 2)]
            public string Ativ12 { get; set; }

            [SpedCampos(25, "ATIV_13", "C", 1, 0, true, 2)]
            public string Ativ13 { get; set; }

            [SpedCampos(26, "DESC_OUTROS", "C", 255, 0, false, 2)]
            public string DescOutros { get; set; }

            [SpedCampos(27, "OBSERVAÇÃO", "C", 1000, 0, false, 2)]
        ...
        public class RegW300 : RegistroSped
        {
            ...
            [SpedCampos(3, "IND_REC_NAO_REL", "C", 1, 0, false, 2)]
            public string IndRecNaoRel { get; set; }

            [SpedCampos(4, "IND_REC_REL", "C", 1, 0, false, 2)]
            public string IndRecRel { get; set; }

            [SpedCampos(5, "IND_REC_TOTAL", "C", 1, 0, false, 2)]
            public string IndRecTotal { get; set; }

            [SpedCampos(6, "IND_LUC_PREJ_ANTES_IR", "C", 1, 0, false, 2)]
            public string IndLucPrejAntesIr { get; set; }

            [SpedCampos(7, "IND_IR_PAGO", "C", 1, 0, false, 2)]
            public string IndIrPago { get; set; }

            [SpedCampos(8, "IND_IR_DEVIDO", "C", 1, 0, false, 2)]
            public string IndIrDevido { get; set; }

            [SpedCampos(9, "IND_CAP_SOC", "C", 1, 0, false, 2)]
            public string IndCapSoc { get; set; }

            [SpedCampos(10, "IND_LUC_ACUM", "C", 1, 0, false, 2)]
            public string IndLucAcum { get; set; }

            [SpedCampos(11, "IND_ATIV_TANG", "C", 1, 0, false, 2)]
            public string IndAtivTang { get; set; }

            [SpedCampos(12, "IND_NUM_EMP", "C", 1, 0, false, 2)]
            public string IndNumEmp { get; set; }

            [SpedCampos(13, "OBSERVAÇÃO", "C", 4000, 0, true, 2)]
            public string Observacao { get; set; }

            [SpedCampos(14, "FIM_OBSERVACAO", "C", 4000, 0, true, 2)]
